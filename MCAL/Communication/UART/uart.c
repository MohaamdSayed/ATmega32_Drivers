/**
 * @file UART.c
 * @brief Source file for UART driver module.
 * @version 1.0
 * @date 2024-07-25
 * @author Mohamed Sayed
 *
 * @details
 * This source file contains functions to be used by the UART driver module.
...
#include "..\..\..\common_macros.h" /* To use the macros like SET_BIT */ /* To use the macros like SET_BIT */
